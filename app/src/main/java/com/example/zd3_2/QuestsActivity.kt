...
class QuestsActivity : AppCompatActivity() {
    ...
    lateinit var genreEdit:EditText

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(layout.activity_quests)
        gridLayout = findViewById(id.gridLayout)
        view = findViewById(id.questsView)
        edit = findViewById(id.editSearch)
        ...
        genreSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                when (position) {
                    ...
                    1 -> {
                        stringArray =
                            setOf("Forrest Gump", "Moana", "Tucker & Dale vs Evil", "Red One")
                    }
            ...
            for (item in stringArray)
            {
                ...
                val stringRequest = StringRequest(
                    ...
                    url,
                    {
                        ...
                        titleTextView.setTextColor(getResources().getColor(color.white))
                        ...
                        yearTextView.setTextColor(getResources().getColor(color.white))
